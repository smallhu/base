...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
    ...
    public function testStartSendsHeloToInitiate()
    {
        /* -- RFC 2821, 3.2.
         ...
         Services extensions and requests that the server provide a list of the
         extensions it supports.  Older SMTP systems which are unable to
         support Services extensions and contemporary clients which do not
         require Services extensions in the mail session being initiated, MAY
         ...
         in the case of EHLO, "and I support Services extension requests").
    ...
    public function testSuccessfulDataCommand()
    {
        ...
        alternative specified in a Services extension).
