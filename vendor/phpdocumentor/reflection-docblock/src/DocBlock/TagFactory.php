...
{
    /**
     * Adds a parameter to the Services locator that can be injected in a tag's factory method.
     *
     ...
     *
     * Another way is to check the name of the argument against the names in the Services Locator. With this method
    ...
    /**
     * Registers a Services with the Services Locator using the FQCN of the class or the alias, if provided.
     *
     * When calling a tag's "create" method we always check the signature for dependencies to inject. If a parameter
     * has a typehint then the ServiceLocator is queried to see if a Services is registered for that typehint.
     *
     * Because interfaces are regularly used as type-hints this method provides an alias parameter; if the FQCN of the
     * interface is passed as alias then every time that interface is requested the provided Services will be returned.
     *
