 ...
 *
 * This Factory also features a Services Locator component that is used to pass the right dependencies to the
 * `create` method of a tag; each dependency should be registered as a Services or as a parameter.
 *
...
final class StandardTagFactory implements TagFactory
{
    ...
    /**
     * @var mixed[] an array representing a simple Services Locator where we can store parameters and
    ...
    /**
     * Returns a copy of this class' Services Locator with added dynamic parameters, such as the tag's name, body and
     * Context.
     *
