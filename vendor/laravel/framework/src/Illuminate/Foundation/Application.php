...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    /**
     * The names of the loaded Services providers.
     *
     * @var array
     */
    ...
    /**
     * Register all of the base Services providers.
     *
     * @return void
     */
    ...
    public function register($provider, $options = [], $force = false)
    {
        ...
        // a more convenient way of specifying your Services provider classes.
    ...
    public function loadDeferredProvider($service)
    {
        ...
        // If the Services provider has not already been loaded and registered we can
        // register it with the application and remove the Services from this list
    ...
    {
        // Once the provider that provides the deferred Services has been registered we
    ...
    /**
     * Boot the given Services provider.
     *
     * @param  \Illuminate\Support\ServiceProvider  $provider
     * @return mixed
     */
