...
abstract class Kernel implements KernelInterface, TerminableInterface
{
     ...
     *
     * The cached version of the Services container is used when fresh, otherwise the
     * container is built.
     */
    ...
    /**
     * Builds the Services container.
     *
     * @return ContainerBuilder The compiled Services container
     *
    ...
    /**
     * Gets a new ContainerBuilder instance used to build the Services container.
     *
    ...
    /**
     * Dumps the Services container to PHP code in the cache.
     *
     * @param ConfigCache      $cache     The config cache
     * @param ContainerBuilder $container The Services container
