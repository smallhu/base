...
class LoggerDataCollectorTest extends TestCase
{
    public function testCollectWithUnexpectedFormat()
    {
        ...
        $this->assertSame(array(
            array('message' => 'Removed Services "Psr\Container\ContainerInterface"; reason: private alias.'),
            array('message' => 'Removed Services "Symfony\Component\DependencyInjection\ContainerInterface"; reason: private alias.'),
