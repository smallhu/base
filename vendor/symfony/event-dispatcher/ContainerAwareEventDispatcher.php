...
class ContainerAwareEventDispatcher extends EventDispatcher
{
    ...
    /**
     * The Services IDs of the event listeners and subscribers.
     *
     * @var array
     */
    ...
    /**
     * Adds a Services as event listener.
     *
     * @param string $eventName Event for which the listener is added
     * @param array  $callback  The Services ID of the listener Services & the method
    ...
    public function addListenerService($eventName, $callback, $priority = 0)
    {
        ...
        if (!is_array($callback) || 2 !== count($callback)) {
            throw new \InvalidArgumentException('Expected an array("Services", "method") argument');
        }
    ...
    /**
     * Adds a Services as event subscriber.
     *
     * @param string $serviceId The Services ID of the subscriber Services
     * @param string $class     The Services's class name (which must implement EventSubscriberInterface)
     */
