...
class RegisterListenersPassTest extends TestCase
{
    ...
    {
        // one Services, not implementing any interface
        $services = array(
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The Services "foo" tagged "kernel.event_listener" must not be abstract.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The Services "foo" tagged "kernel.event_subscriber" must not be abstract.
     */
