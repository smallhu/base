...
class AddConsoleCommandPassTest extends TestCase
{
    ...
    public function testProcess($public)
    {
        ...
        if ($public) {
            ...
            // in case the original Services is private
     ...
     * @expectedExceptionMessage The Services "my-command" tagged "console.command" must not be abstract.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The Services "my-command" tagged "console.command" must be a subclass of "Symfony\Component\Console\Command\Command".
     */
